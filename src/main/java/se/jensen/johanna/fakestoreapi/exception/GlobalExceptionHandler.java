...
import se.jensen.johanna.fakestoreapi.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleException(BadCredentialsException e,
    ...
    return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
        .body(buildErrorResponse(e, HttpStatus.UNAUTHORIZED, "INVALID_CREDENTIALS", request));
  }
  ...
  public ResponseEntity<ErrorResponse> handleException(Exception e, HttpServletRequest request) {
    ...
    return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
        buildErrorResponse(e, HttpStatus.INTERNAL_SERVER_ERROR, "INTERNAL_SERVER_ERROR", request));
  }
